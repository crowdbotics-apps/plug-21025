...
admin.site.site_header = "Plug"
admin.site.site_title = "Plug Admin Portal"
admin.site.index_title = "Plug Admin"

# swagger
api_info = openapi.Info(
    title="Plug API",
    default_version="v1",
    description="API documentation for Plug App",
)
